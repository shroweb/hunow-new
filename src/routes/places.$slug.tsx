...
export const Route = createFileRoute("/places/$slug")({
  ...
  head: ({ loaderData, params }) => {
    ...
    return {
      ...
      links: [
        { rel: "canonical", href: l.seo?.canonicalUrl ?? `https://www.hunow.co.uk${url}` },
      ...
      scripts: [
        {
          ...
          children: JSON.stringify((() => {
            ...
            return {
              ...
              image,
              url: l.website ?? `https://www.hunow.co.uk${url}`,
              sameAs: l.website,
              telephone: l.phone,
              ...
              address: {
                "@type": "PostalAddress",
                streetAddress: l.address || "Kingston upon Hull",
          ...
          children: JSON.stringify({
            ...
            itemListElement: [
              { "@type": "ListItem", position: 1, name: "Home", item: "https://www.hunow.co.uk" },
              {
                ...
                position: 2,
                name: "Places",
                item: "https://www.hunow.co.uk/places",
              },
              { "@type": "ListItem", position: 3, name: l.name, item: `https://www.hunow.co.uk${url}` },
            ],
          }),
        },
      ],
